...
namespace OCLTTraceUtils
{
	...
	bool OverlapLineTraceSingleByProfile(const UWorld* World, const FVector& Start, const FVector& End, FName ProfileName, const struct FCollisionQueryParams& Params, bool bDrawDebug, float DrawTime, FColor HitColor);
}